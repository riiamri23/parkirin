...
class Keluar extends CI_Controller {
	...
	public function kendaraankeluar($value=''){
		...
		$sqlcek_member = $this->db->query("SELECT * FROM tbl_masuk RIGHT JOIN tbl_kendaraan ON tbl_masuk.kd_kendaraan = tbl_kendaraan.kd_kendaraan WHERE kd_member = '".$member."' order by tgl_masuk desc LIMIT 1")->row_array();
