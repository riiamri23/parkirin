...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$data['jenis'] = $this->db->query("SELECT count(*) as total FROM tbl_masuk RIGHT JOIN tbl_kendaraan ON tbl_masuk.kd_kendaraan = tbl_kendaraan.kd_kendaraan WHERE status_masuk = '1'")->row_array();
		$data['admin'] = $this->db->query("select count(*) as total from tbl_member")->row_array();
		// die(print_r($data));
