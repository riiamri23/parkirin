                      ...
                      <div class="row">
                        <div class="col-8">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" placeholder="NIM Member" required="" name="nim" >
                          </div>
                          <div class="form-group">
                            <label for="password">Password</label>
                            <input type="password" class="form-control" id="" placeholder="Password Member" required="" name="password" >
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="fakultas">Fakultas</label>
                              <select class="form-control" name="fakultas" required="" id="fakultas">
                                ...
                                <option value="Fakultas Ilmu Bahasa">Fakultas Ilmu Bahasa</option>
                              </select>
                          </div>
                          <div class="form-group">
