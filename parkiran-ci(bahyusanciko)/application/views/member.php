              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach ($member as $row) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('member/view/'.$row['kd_member']) ?>" class="btn btn-warning">EDIT</a>
                      <a href="<?=base_url('member/delete/' . $row['kd_member'])?>" class="btn btn-danger" OnClick="return confirm('Apa anda yakin ingin mendelete ini?');">DEL</a>
                    </td>
                  </tr>
                <?php } ?>
                </tfoot>
